...
public class CourseScheduler 
{
   ...
   */
   ...
   /**
      ...
      -promising method is called to check if the perticular course fits in given slot.
      -Last course's slot is checked along with promising to check if the program should execute further.
   ...
   */
   ...
   {  
      ...
      {
         if(promising(vertex,slot) && (vcolor[noOfCourses-1]==0))
         {
            vcolor[vertex]= slot;
...
//       while((size<adjacents.size()))
   for(int size=0;size<adjacents.size();size++)
      {
         for(int i=0;i<noOfCourses;i++)
         {
...
// 
// //       String shortPathInfected = nodes.get(infectedPerson);
//       int num = path1.indexOf(infectedPerson);
// //       String shortPathTarget = nodes.get(target);
//       int num1 = path1.indexOf(target);
//       
//       ArrayList<String> shortestPath = new ArrayList<>();
//       for(int i= num;i>num1;i--)
//       {
//          if(!shortestPath.contains(path.get(i)))
//          {
...
//          
//       }
//       if(!shortestPath.contains(infectedPerson))
//       {
//          shortestPath.add(0,infectedPerson);
//       }
//       
//       return shortestPath;